        ...
        <section className="md:p-10">
          ...
          <div className="mt-6 space-y-4 leading-7">
            <p>
              ...
              , where more than 300 colleagues were let go. It happened so fast
              that I didn't even get to say goodbye to some of them.
            </p>
            <p>
              Building websites is what I do best, so I wanted to find a way to
              help and this is it: a focused jobs feed that aggregates
              journalism roles from various job boards, all in one place.
            </p>

            <p>
              Job listings are pulled from multiple sources once a day
              automatically, then aggregated and published here. Let me know if
              you would like additional sources to keep track.
            </p>

            <p>
              This site is open-source. If you're a software engineer and want
              to contribute, pull requests are welcome on{" "}
              <a
                className="text-(--brand) underline underline-offset-2"
